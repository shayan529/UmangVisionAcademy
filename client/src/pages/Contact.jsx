    ...
    <div className="min-h-screen bg-[#0B1120] text-white">
      ...
      <section className="px-6 md:px-10 py-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            <p className="text-indigo-400 font-semibold mb-4">CONTACT US</p>

            <h1 className="text-5xl md:text-6xl font-bold leading-tight">
              Let’s Build The Future Of{' '}
              <span className="text-indigo-400">AI Learning</span>
            </h1>

            <p className="text-slate-400 mt-8 text-lg leading-relaxed">
              Have questions, feedback, or business inquiries? Reach out to our
              team and we’ll help you with courses, subscriptions, instructor
              onboarding, technical support, and enterprise solutions.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-5 mt-10">
              ...
              <div className="bg-white/5 border border-white/10 p-6 rounded-3xl">
                ...
                <p className="text-slate-400 mt-3">+91 98765 43210</p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-6 rounded-3xl">
                ...
                <p className="text-slate-400 mt-3">
                  business@umangvisionacademy.com
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-6 rounded-3xl">
                ...
                <p className="text-slate-400 mt-3">Mon - Sat / 9AM - 7PM</p>
              </div>
            </div>
          </div>

    ...
    questions: [
      {
        ...
        answer:
          "Go to the Become Instructor page and submit your application.",
      },
      {
        question: "Can instructors earn revenue?",
        answer:
          "Yes, instructors can monetize courses and track earnings from the instructor dashboard.",
      },
    ],
  },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-slate-400 mt-6 text-lg leading-relaxed">
              Find answers about courses, AI features,
              certifications, instructor tools, business plans,
          ...
          <div className="mt-24 bg-gradient-to-r from-indigo-500/20 to-cyan-500/20 border border-white/10 rounded-[40px] p-10 md:p-14 text-center">
            ...
            <p className="text-slate-300 mt-5 text-lg max-w-2xl mx-auto">
              Contact our support team for technical help,
              subscription assistance, instructor onboarding,

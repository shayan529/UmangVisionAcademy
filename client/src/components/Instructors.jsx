...
const benefits = [
  {
    title: "Earn Revenue",
    desc: "Monetize your skills and earn money by selling courses worldwide.",
    icon: "💰",
  },
        ...
        <div className="max-w-7xl mx-auto grid gap-10 lg:grid-cols-2 items-center relative z-10">
          ...
          <div>
            ...
            <p className="text-slate-400 text-lg md:text-xl mt-8 leading-relaxed">
              Share your expertise, build your community,
              host live sessions and earn revenue through
              your own online courses and mentorship programs.
            </p>
            ...
            <div className="flex flex-wrap gap-5 mt-10">
              ...
              <Link to="/become-instructor" className="bg-indigo-600 hover:bg-indigo-700 transition duration-300 px-8 py-4 rounded-2xl text-white font-semibold shadow-xl shadow-indigo-500/20 inline-flex items-center justify-center">
                Start Teaching
              </Link>

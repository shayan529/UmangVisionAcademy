    ...
    >
      ...
      <div className="relative shrink-0 mt-0.5">
        ...
        {conv.assistanceActive && (
          <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-emerald-500 border-2 border-[#161922] rounded-full" title="Assistance Active" />
        )}
      </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative">
                  <button
                    ...
                    className="p-2 rounded-xl border border-zinc-800 bg-[#1a1d26] hover:bg-zinc-800 text-zinc-300 transition cursor-pointer"
                  >

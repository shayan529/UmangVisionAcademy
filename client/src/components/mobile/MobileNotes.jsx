      ...
      <div className="flex flex-col border-b border-slate-800 bg-slate-950/80 backdrop-blur">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-extrabold text-white">Class Notes</h3>
          ...
          <div className="space-y-3">
            {loadingClassNotes ? (
              ...
              classNotes.map((note) => (
                <div
                  key={note._id}
                  className="p-3.5 bg-slate-900/35 border border-slate-800/80 rounded-2xl hover:border-slate-700/60 transition flex flex-col gap-3"
                >

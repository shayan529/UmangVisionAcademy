...
export default function MobileChat() {
  ...
  useEffect(() => {
    const updateHeight = () => {
      ...
      document.querySelectorAll("body *").forEach((el) => {
        ...
        const isPinnedToBottom = Math.abs(vh - rect.bottom) < 2;
        if (isPinnedToBottom && rect.height > 0 && rect.height < 140) {
          bottomNavHeight = Math.max(bottomNavHeight, rect.height);
        }
      });

      setContainerHeight(`${Math.max(vh - top - bottomNavHeight, 300)}px`);
    };
  ...
  const deleteSession = useCallback(
    (id) => {
      ...
      // Best-effort delete on the backend. If the session never made it
      // to the server (e.g. no message was ever sent from it), the
      ...
      (async () => {
        try {
          ...
          // Non-fatal: UI already reflects the deletion. Let the user
          // know the server copy might not have been cleared.
          dispatch(
            setError(
              "Couldn't delete this conversation from history. It may reappear later.",
            ),
          );
        }
      })();
      ...
      >
        ...
        {requireLogin ? (
          ...
          >
            ...
            >
              <div style={{ fontSize: isMobile ? 30 : 36, marginBottom: 10 }}>
                🔐
              </div>
              <div
                style={{
              ...
              >
                Sign in to start chatting with the AI tutor and access your
          ...
          >
            ...
            >
              <div
                style={{
                  ...
                  minHeight: hasMessages ? undefined : "auto",
            ...
            <div
              style={{
                padding: isMobile ? "4px 8px 6px" : "10px 20px 14px",
                background: t.bg,
                flexShrink: 0,

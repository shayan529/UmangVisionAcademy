        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-center">
          <div className="space-y-8">
            ...
            <p className="max-w-2xl text-slate-400 text-lg leading-8">
              Join 300+ instructors building courses that reach thousands of
              learners. Submit your application, get verified fast, and start
              teaching with AI-supported tools.
            </p>
          </div>
          ...
          <div className="rounded-[32px] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-indigo-500/10 flex flex-col justify-between">
            <div className="space-y-4 mb-6">
              ...
              <p className="text-slate-400 leading-7">
                Fill in your expertise and sample content to get started. Our
                team will reach out within 24 hours with next steps.
              </p>
            </div>
            <button
              type="button"
        ...
        <section className="mt-16 grid gap-12 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="space-y-8">
            <div className="rounded-[32px] border border-white/10 bg-white/5 p-8 shadow-lg shadow-indigo-500/5">
              ...
              <h2 className="mt-4 text-3xl font-bold text-white">
                A simple process to launch your first course
              </h2>
              <p className="mt-4 text-slate-400 leading-7">
                Apply with your expertise, get verified quickly, and publish
                your first course to start earning from day one.
              </p>
          ...
          <div className="rounded-[32px] border border-white/10 bg-slate-900/80 p-8 shadow-2xl shadow-indigo-500/10 flex flex-col justify-center items-center text-center">
            <div className="space-y-6 max-w-md my-auto">
              ...
              <p className="text-slate-400 leading-7">
                Are you ready to share your expertise and shape the future of
                learning? Submit your application and become part of our
                world-class coaching community.
              </p>
              <div className="pt-6">
                <button
                  type="button"

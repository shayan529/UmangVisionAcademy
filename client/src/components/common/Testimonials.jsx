...
const Testimonials = () => {
  ...
  return (
    <section className="relative px-6 sm:px-10 py-10 sm:py-12 bg-[#0B1120] overflow-hidden text-slate-100">
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          {/* Featured card */}
          <div className="lg:col-span-3 group relative flex flex-col justify-between rounded-2xl border border-amber-500/20 bg-gradient-to-br from-[#151F35] to-[#0F1729] p-5 sm:p-6 overflow-hidden transition-all duration-300 hover:border-amber-500/40 hover:shadow-[0_12px_30px_rgba(242,169,59,0.08)]">
            <Quote
              size={60}
              className="absolute -top-2 -left-2 text-amber-500/[0.07] pointer-events-none"
            />

            {/* Admit-card style verified seal */}
            <div className="absolute top-4 right-4 sm:top-5 sm:right-5 -rotate-6 flex flex-col items-center justify-center w-13 h-13 rounded-full border-2 border-dashed border-amber-400/40 text-amber-400 p-1">
              <ShieldCheck size={16} strokeWidth={2.5} />
              <span className="font-mono text-[7px] font-bold tracking-widest mt-0.5">
                VERIFIED
              </span>
            </div>
            ...
            <div className="relative z-10 space-y-3 pr-12">
              ...
              <p className="font-serif text-base sm:text-lg text-slate-100 leading-snug">
                “{t(featured.quoteKey, featured.defaultQuote)}”
              </p>
            </div>

            <div className="relative z-10 pt-4 mt-4 border-t border-slate-800/80 flex items-center gap-3">
              <div
                className={`w-10 h-10 rounded-xl bg-gradient-to-br ${featured.gradient} flex items-center justify-center font-bold text-white text-xs shrink-0 shadow-md`}
              >
                {featured.initials}
              </div>
              <div className="min-w-0">
                ...
                <p className="font-mono text-[10px] text-amber-400/80 truncate mt-0.5 tracking-wide">
          ...
          <div className="lg:col-span-2 grid grid-rows-2 gap-4">
            {rest.map((item, i) => (
              <div
                key={i}
                className="group relative flex flex-col justify-between rounded-2xl border border-slate-800/80 bg-[#111827]/80 p-4 sm:p-5 backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:border-indigo-500/40 hover:shadow-[0_8px_20px_rgba(99,102,241,0.1)]"
              >
                ...
                <div className="pt-3 mt-3 border-t border-slate-800/80 flex items-center gap-3 relative z-10">
                  <div
                    className={`w-9 h-9 rounded-lg bg-gradient-to-br ${item.gradient} flex items-center justify-center font-bold text-white text-[11px] shrink-0 shadow-md group-hover:scale-105 transition-transform`}
                  >
                    {item.initials}
                  </div>
                  <div className="min-w-0">
        ...
        <div className="pt-5 border-t border-slate-800/60 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-10 text-center font-mono">

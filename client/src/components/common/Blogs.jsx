...
const ROJGAR_EN = [
  ...
  },
  {
    ...
    benefit: '₹15,000 toolkit grant + ₹3 lakh collateral-free loan at 5% interest',
    deadline: 'Open',
    status: 'active',
...
const ROJGAR_HI = [
  ...
  },
  {
    ...
    benefit: 'प्रूफ ऑफ कॉन्सेप्ट के लिए ₹20 लाख तक का अनुदान + व्यावसायीकरण के लिए ₹50 लाख',
...
const MOCK_NEWS_EN = [
  {
    ...
    excerpt: 'CBSE has rolled out a free digital library initiative to support rural learners with interactive study material, past papers and instructional videos.',
  ...
  },
  {
    ...
    excerpt: 'The NTA has announced a correction window for JEE Main form updates, giving candidates another chance to fix their exam centre and subject details.',
  ...
  },
  {
    ...
    excerpt: 'Several state boards have begun revising their school syllabi to reflect the new interdisciplinary and competency-based learning outcomes promoted by NEP 2020.',
  ...
  },
  {
    ...
    excerpt: 'EdTech startups are reporting higher engagement from students using AI tutoring apps for exam prep, video lessons and adaptive quizzes.',
  ...
  },
  {
    ...
    excerpt: 'A government scholarship portal has opened fresh registrations for women pursuing STEM degrees, offering tuition support and mentorship.',
  ...
  },
  {
    ...
    excerpt: 'CBSE has published a revised academic calendar that includes dedicated summer revision camps for Class 10 and 12 students.',
...
const MOCK_NEWS_HI = [
  {
    ...
    excerpt: 'सीबीएसई ने ग्रामीण शिक्षार्थियों को इंटरैक्टिव अध्ययन सामग्री, पिछले वर्ष के प्रश्नपत्रों और शैक्षणिक वीडियो के साथ समर्थन देने के लिए एक मुफ्त डिजिटल लाइब्रेरी पहल शुरू की है।',
  ...
  },
  {
    ...
    excerpt: 'एनटीए ने जेईई मेन फॉर्म अपडेट के लिए सुधार विंडो की घोषणा की है, जिससे उम्मीदवारों को अपने परीक्षा केंद्र और विषय विवरण को ठीक करने का एक और मौका मिला है।',
  ...
  },
  {
    ...
    category: 'नीति',
    tag: 'एनईपी 2020',
    title: 'राज्य शिक्षा बोर्डों ने पाठ्यक्रम को एनईपी 2020 के सुधारों के अनुरूप संरेखित करना शुरू किया',
    excerpt: 'कई राज्य बोर्डों ने एनईपी 2020 द्वारा प्रचारित नए अंतःविषय और योग्यता-आधारित शिक्षण परिणामों को दर्शाने के लिए अपने स्कूल के पाठ्यक्रम को संशोधित करना शुरू कर दिया है।',
  ...
  },
  {
    ...
    excerpt: 'एडटेक स्टार्टअप छात्रों द्वारा परीक्षा की तैयारी, वीडियो पाठ और अनुकूली क्विज़ के लिए एआई ट्यूशन ऐप के उपयोग में उच्च जुड़ाव दर्ज कर रहे हैं।',
  ...
  },
  {
    ...
    excerpt: 'एक सरकारी छात्रवृत्ति पोर्टल ने विज्ञान, प्रौद्योगिकी, इंजीनियरिंग और गणित (STEM) की पढ़ाई कर रही महिलाओं के लिए नए पंजीकरण शुरू किए हैं, जिसमें ट्यूशन सहायता और मेंटरशिप प्रदान की जा रही है।',
  ...
  },
  {
    ...
    category: 'शिक्षा',
    tag: 'सीबीएसई',
    title: 'सीबीएसई ने ग्रीष्मकालीन रिवीजन शिविरों के लिए शैक्षणिक कैलेंडर अपडेट किया',
    excerpt: 'सीबीएसई ने एक संशोधित शैक्षणिक कैलेंडर प्रकाशित किया है जिसमें कक्षा 10 और 12 के छात्रों के लिए समर्पित ग्रीष्मकालीन रिवीजन शिविर शामिल हैं।',
...
const CategoryPill = ({ label, active, onClick }) => (
  <button
    onClick={onClick}
    className={`px-4 py-2 rounded-full border transition-all duration-200 text-sm font-semibold whitespace-nowrap cursor-pointer hover:scale-[1.02] ${active
          ...
          <div className="flex bg-slate-950/80 rounded-xl p-1 border border-slate-800/80">
            {[
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-lg text-sm font-bold transition-all duration-200 cursor-pointer ${activeTab === tab.key
            ...
            <div className="p-6 sm:p-10">
              ...
              <div className="flex items-center gap-4 py-4 border-y border-slate-800/80 mb-8 flex-wrap justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-slate-200">{t('blogs.writtenBy')}</p>
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            {newsLoading && (
              <div className="space-y-8">
                ...
                <div className="bg-[#101935] border border-slate-900 rounded-2xl p-6 flex items-center justify-center gap-4 text-violet-400 font-semibold text-sm">
                  ...
                  {isHindi ? 'नवीनतम शिक्षा समाचार लोड हो रहा है...' : 'Fetching latest education posts...'}
                </div>
                {/* Skeletons Grid */}
            ...
            {newsError && !newsLoading && (
              <div className="bg-rose-500/5 border border-rose-500/20 rounded-2xl p-6 text-center max-w-md mx-auto">
                ...
                <h3 className="text-lg font-bold text-white mb-2">{newsError}</h3>
                <button
                  onClick={() => {
                    setNewsLoading(true);
                    setNewsError(null);
                    fetchNewsFromAI(currentLanguage)
                      .then(setNewspaper)
                      .catch(() => setNewsError(isHindi ? 'लोड करने में विफल।' : 'Failed to load.'))
              ...
              <>
                {filteredNews.length === 0 ? (
                  <div className="text-center py-20 bg-[#101935]/30 border border-slate-900/40 rounded-3xl">
                    ...
                    <h3 className="text-xl font-bold text-slate-400">{t('blogs.noArticlesFound')}</h3>
                  </div>
                ) : (
                  <div className="space-y-8">
                    {/* FEATURED CARD */}
                      ...
                      >
                        ...
                        >
                          <div
                            ...
                            style={{ backgroundColor: featured.color, color: '#0b1329' }}
                          >
                            📰
                          </div>
                        </div>
                        ...
                        <div className="lg:w-3/5 p-8 flex flex-col justify-center gap-4">
                          <div className="flex items-center gap-3">
                            <span
                              className="text-[10px] font-bold px-2.5 py-0.5 rounded-full tracking-wider uppercase border border-amber-500/25 bg-amber-500/10 text-amber-400"
                            >
                              {t('blogs.featuredLabel')}
                            </span>
                            <NewsBadge label={featured.category} color={featured.color} />
                            <NewsBadge label={featured.tag} color={featured.color} />
                          </div>
                    ...
                    {/* REST OF NEWS GRID */}
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {(newsSearch !== '' ? filteredNews : restNews).map((article) => (
                        <div
                          key={article.id}
                        ...
                        >
                          ...
                          <div className="flex flex-wrap gap-2">
                            <NewsBadge label={article.category} color={article.color} />
                            <NewsBadge label={article.tag} color={article.color} />
                          </div>
        ...
        {activeTab === 'rojgar' && (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                >
                  ...
                  />
                  <div className="text-3xl font-extrabold text-white" style={{ color: stat.color }}>
                    {stat.value}
                  </div>
            ...
            {filteredRojgar.length === 0 ? (
              <div className="text-center py-20 bg-[#101935]/30 border border-slate-900/40 rounded-3xl">
                <FileText className="mx-auto text-slate-600 mb-4" size={48} />
                <h3 className="text-xl font-bold text-slate-400">{t('blogs.noSchemesFound')}</h3>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2 pt-2 text-xs sm:text-sm border-t border-slate-800/30">
                        {[
                          { label: isHindi ? 'मंत्रालय' : 'Ministry', value: scheme.ministry },
                          { label: isHindi ? 'पात्रता' : 'Beneficiary', value: scheme.beneficiary },
                          { label: isHindi ? 'लाभ' : 'Benefit', value: scheme.benefit },
                          { label: isHindi ? 'समय सीमा' : 'Deadline', value: scheme.deadline },
                        ].map((row, idx) => (

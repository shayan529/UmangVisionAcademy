          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="text-slate-400 mt-3 text-sm leading-relaxed max-w-lg">
                Explore structured courses for the {label} Board — curated by
                verified instructors across all classes and subjects.
              </p>
            </div>
            ...
            {!loading && (
              <div className="flex gap-4 flex-wrap">
                {[
                  { label: "Courses", value: boardCourses.length },
                  { label: "Classes", value: classes.length - 1 },
                  { label: "Subjects", value: subjects.length - 1 },
                ].map((s) => (
                  <div
                    key={s.label}
        ...
        {loading ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-slate-400 mt-3 text-sm">
              Instructors haven't published courses for this board yet. Check
              back soon!
            </p>
            <button

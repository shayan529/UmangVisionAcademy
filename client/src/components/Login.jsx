          ...
          <div className="w-full max-w-md su" style={{ animationDelay:".35s" }}>
            ...
            <div className="card-glow rounded-3xl p-9"
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="df text-3xl font-black text-white">Welcome Back</h2>
                <p className="text-slate-400 mt-1.5 text-sm">Continue your learning journey</p>
              </div>

            ...
            <div className="flex items-center justify-between px-2.5 sm:px-5 py-2.5 sm:py-3.5 border-b border-[#1a244d] bg-[#0b1028] shrink-0 gap-2">
              <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                ...
                <div className="relative shrink-0">
                  {instructor?.avatarUrl ? (
                    ...
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-gradient-to-br from-emerald-500 via-teal-600 to-emerald-700 flex items-center justify-center text-white font-bold text-xs sm:text-sm ring-2 ring-emerald-500/60 shadow-sm">
                      {initialOf(instructor?.name)}
                    </div>
                  )}
                  <span className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-emerald-500 border-2 border-[#101738] rounded-full shadow-xs" />
                </div>
                <div className="min-w-0 flex-1 pr-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="hidden sm:inline-flex text-[9px] font-bold text-emerald-400 bg-emerald-500/15 border border-emerald-500/30 px-1.5 py-0.5 rounded-md uppercase tracking-wider shrink-0">
                      FACULTY
                    </span>
                  </div>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                <button
                  ...
                  className="w-9 h-9 sm:w-auto sm:px-3.5 sm:py-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-bold flex items-center justify-center transition-all shadow-md shadow-emerald-600/20 active:scale-95 cursor-pointer shrink-0"
                >
                  <Video size={16} />

    ...
    >
      ...
      <div className="relative shrink-0 mt-0.5">
        {instructor?.avatarUrl ? (
          ...
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 flex items-center justify-center text-white font-bold text-sm shadow-sm">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center justify-between gap-1 mb-1">
          <div className="flex items-center gap-1.5 truncate">
            ...
            <span className="text-[9px] font-bold uppercase tracking-wider text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-1.5 py-0.2 rounded-md shrink-0">
              Faculty
            </span>
          </div>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-md p-4 pro-msg-in">
          <div className="w-full max-w-md rounded-3xl border border-emerald-500/50 bg-[#161922] p-6 sm:p-7 shadow-2xl">
            ...
            {approvedMeeting.response && (
              <p className="mt-4 text-xs text-zinc-300 bg-zinc-900/80 p-3.5 rounded-xl border border-zinc-800 leading-relaxed">
                "{approvedMeeting.response}"
              </p>
            )}
            <div className="mt-4 rounded-2xl border border-emerald-500/30 bg-zinc-950 p-4">
        ...
        {view === "selector" && (
          <div className="flex-1 overflow-y-auto pro-chat-scroll p-4 space-y-4">
            ...
            {availableLoading && (
              <div className="space-y-3">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 p-3.5 rounded-2xl bg-zinc-900/50 animate-pulse border border-zinc-800/40"
                  >
            ...
            {!availableLoading && availableInstructors.length === 0 && (
              <div className="text-center py-12 px-4 bg-zinc-900/40 rounded-3xl border border-zinc-800/80 my-4 space-y-3">
                  ...
                  >
                    {item.thumbnail ? (
                      <img
                        ...
                        className="w-12 h-12 rounded-xl object-cover shrink-0 border border-zinc-700/60 mt-0.5"
                      />
                    ) : (
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-zinc-800 to-zinc-900 border border-zinc-700/50 flex items-center justify-center text-emerald-400 font-bold shrink-0 mt-0.5">
                        <BookOpen size={20} />
                      </div>
                    )}
                    <div className="min-w-0 flex-1">
        ...
        {!activeConversation ? (
          ...
          <>
              ...
              <div className="flex items-center gap-3.5 min-w-0">
                ...
                <div className="relative shrink-0">
                  {instructor?.avatarUrl ? (
                    ...
                    <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 flex items-center justify-center text-white font-bold text-sm ring-2 ring-emerald-500/60 shadow-sm">
                      {initialOf(instructor?.name)}
                    </div>
                  )}
                ...
                <div className="min-w-0">
                  <h3 className="text-sm font-bold text-white truncate flex items-center gap-2">
                    {instructor?.name}
                    <span className="text-[10px] font-bold text-emerald-400 bg-emerald-500/15 border border-emerald-500/30 px-2 py-0.2 rounded-md">
                      Instructor
                    </span>
                  </h3>
                  <p className="text-xs text-zinc-400 truncate flex items-center gap-1.5 mt-0.5">
                    <span className="text-zinc-300 font-medium">{activeConversation.course?.title || "General Query"}</span>
              ...
              <div className="flex items-center gap-2">
                ...
                {activeCallRequest && (
                  <button
                    ...
                    className="text-xs text-zinc-400 hover:text-rose-400 px-3 py-2 rounded-xl border border-zinc-800 hover:border-rose-500/40 transition cursor-pointer"
                  >
                    Cancel
                  </button>
                )}
            ...
            {activeConversation?.assistanceDisabled && (
              <div className="absolute inset-0 z-30 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-fadeIn">
                <div className="w-full max-w-md rounded-3xl border border-emerald-500/40 bg-[#161922]/95 p-6 sm:p-7 shadow-2xl text-center relative overflow-hidden">
                  ...
                  <div className="mt-5 space-y-2.5 text-left bg-zinc-900/80 rounded-2xl border border-zinc-800 p-4">
            ...
            >
              ...
              {!messagesLoading && messages.length === 0 && (
                <div className="flex flex-col items-center justify-center text-center py-16 px-4 gap-3.5">
                  <div className="w-16 h-16 rounded-3xl bg-[#161922] border border-zinc-800 flex items-center justify-center text-3xl mb-1 shadow-inner">
                    👋
                  </div>
